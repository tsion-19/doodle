...
urlpatterns += path("meeting/<str:meeting_id>/vote/", api_meeting_vote, name="api_meeting_vote"),
urlpatterns += path("meeting/<str:meeting_id>/timeslots/", api_meeting_timeslots, name="api_meeting_timeslots"),
# Vote options
urlpatterns += path("meeting/vote-options/", api_meeting_vote_options, name="api_meeting_vote_options"),
# Feedbacks
